...
@Component({
  selector: 'app-day-xvii',
  templateUrl: './day-xvii.component.html',
  styleUrls: ['./day-xvii.component.scss']
})
export class DayXVIIComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.httpClient.get('assets/input-data/input17.txt', { responseType: 'text' }).subscribe(data => {
      // this.result1 = this.solve(this.data, 2022);
      this.result1 = this.solve(data, 2022);
      this.result2 = this.solve(data, 1000000000000);
    });
  }
